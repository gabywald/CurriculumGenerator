...
def interactiveCompletionSkillsJobsTraining( personnae, args ) : 
  ...
  if (noelts) : 
    ...
    if (personnae.skilleltnb == None) and ( (personnae.skills == None) or (personnae.skills == []) ) : 
      personnae.skilleltnb = askForInt( "Number of Skills elements ?" )
    elif (personnae.skilleltnb == None) and (len(personnae.skills) > 0):
      ...
      personnae.skilleltnb  = len(personnae.skills)
    if (personnae.jobeltsnb == None) and ( (personnae.jobs == None) or (personnae.jobs == []) ) : 
      personnae.jobeltsnb = askForInt( "Number of Jobs elements ?" )
    elif (personnae.jobeltsnb == None) and (len(personnae.jobs) > 0):
      ...
      personnae.jobeltsnb  = len(personnae.jobs)
    if (personnae.trainingeltsnb == None) and ( (personnae.trainings == None) or (personnae.trainings == []) ) : 
      personnae.trainingeltsnb = askForInt( "Number of Training elements ?" )
    elif (personnae.trainingeltsnb == None) and (len(personnae.trainings) > 0):
...
def interactiveCompletionOf( personnae, args ) : 
  ...
  # print( args.randomskillelements )
  # print( args.randomjobelements )
  # print( args.randomtrainingelements )
  if ( (args.randomskillelements) and (personnae.skilleltnb == None) ) :
    personnae.skilleltnb = random.randint(1, 20)
  if ( (args.randomjobelements) and (personnae.jobeltsnb == None) ) :
    personnae.jobeltsnb = random.randint(1, 20)
  if ( (args.randomtrainingelements) and (personnae.trainingeltsnb == None) ) :
