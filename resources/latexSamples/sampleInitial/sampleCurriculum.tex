...
\section{Comp{\'e}tences}
	Introduction Text !!~\\
% possibilit{\'e} de mettre les entr{\'e}es en deux colonnes 
\cvdoubleitem{ Item1 }{ Description1 }{ Item2 }{ Description2 }
\cvcomputer{Espagnol}{Bon niveau}{Système \newline d'exploitation}{Microsoft office, Linux}
...
\cvitem{SocialGames}{ SOCIALGAMES }
